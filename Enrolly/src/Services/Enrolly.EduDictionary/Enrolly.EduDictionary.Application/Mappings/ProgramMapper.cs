...
//autogenerated mapper (ProgramDto <-> Program)
[Mapper(RequiredMappingStrategy = RequiredMappingStrategy.None)]
public partial class ProgramMapper
{
    [MapProperty(nameof(Program.CreatedAt), nameof(ProgramDto.CreateTime))] 
    public partial ProgramDto ToDto(Program? model);
    public partial IEnumerable<ProgramDto> ToDtos(IEnumerable<Program>? models);
    
    [MapProperty(nameof(ProgramDto.CreateTime), nameof(Program.CreatedAt))] 
