...
public class DocumentScansService : IDocumentScansService
{
    private readonly IFileStorageService _fileStorageService;
    private readonly IScanRepository _scanRepository;
    private readonly string _bucketName = "enrolly-documents-diplomas";
    
    public DocumentScansService(IFileStorageService fileStorageService, IScanRepository scanRepository)
    {
