        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CitizenshipId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicantManager_Applicants_PendingApplicantsId",
                        column: x => x.PendingApplicantsId,
                        principalTable: "Applicants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicantManager_Managers_ManagersId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("22222222-2222-2222-2222-222222222222"), "222cf406-7901-45e0-a625-2fd0f8ab2b27", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), 0, "0f8fad5b-d9cb-469f-a165-70867728950e", "ivanovdanil.hits2024@gmail.com", true, false, null, "IVANOVDANIL.HITS2024@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAEK/Rx9lXaMVl2XRpYwE8soOLgg4u8mECM985xTPE+23pqnopjLqH1iyxEVhE0Y8c8A==", null, false, "7c9e6679-7425-40de-944b-e07fc1f90ae7", false, "admin" });
