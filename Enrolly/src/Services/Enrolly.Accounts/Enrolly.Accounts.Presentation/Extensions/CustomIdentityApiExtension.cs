        ...
        where TUser : class, new()
    {
        ...
        */
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(MapCustomIdentityApiUsingJwt)}-{finalPattern}";
                ...
                [FromServices] IEmailSender<TUser> emailSender) =>
        {
            ...
            await SendConfirmationEmailAsync(emailSender, user, userManager, context, resendRequest.Email);
            return TypedResults.Ok();
        });*/

        /*routeGroup.MapPatch("/credentials/password", async Task<Results<Ok, ValidationProblem>>
        ...
        /*routeGroup.MapPatch("/credentials/email", async Task<Results<Ok, ValidationProblem>>
        ([FromBody] ForgotPasswordRequest resetRequest, 
            [FromServices] IServiceProvider sp,
            [FromServices] IEmailSender<TUser> emailSender) =>
        {
                ...
                [FromServices] IEmailSender<TUser> emailSender) =>
        {
            ...
            if (!string.IsNullOrEmpty(infoRequest.NewEmail))
            {
                ...
                {
                    await SendConfirmationEmailAsync(emailSender, user, userManager, context, infoRequest.NewEmail, isChange: true);
                }
            }
